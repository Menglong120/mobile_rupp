...
import 'package:customer_order_app/data/services/category_service.dart';
...
class HomeController extends GetxController {
  ...
  void fetchProduct() async {
    try {
      ...
      final List<Map<String, dynamic>> categoryResult = futures[0] as List<Map<String, dynamic>>;
      final List<ProductModel> productResult = futures[1] as List<ProductModel>;
      
      // Update categories list
      var newCategories = <Map<String, dynamic>>[{'id': 0, 'name': 'All'}];
      ...
      listCategori.assignAll(newCategories);
