    ...
    <aside className="w-72 bg-white border-r border-gray-100 h-screen sticky top-0 flex flex-col transition-all duration-300 shadow-2xl shadow-gray-100/50">
      <div className="p-10 border-b border-gray-50 flex items-center justify-center">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-black text-gray-900 leading-tight tracking-tighter uppercase italic px-1 bg-primary text-white rounded skew-y-1">ShoeApp</h1>
            <span className="text-[10px] font-black tracking-[0.2em] text-gray-400 uppercase italic pl-1">Admin Panel</span>
          </div>
        </div>
      </div>
