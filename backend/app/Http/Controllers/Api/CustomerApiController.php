...
class CustomerApiController extends Controller
{
    ...
    public function auth(Request $request)
    {
        ...
        if ($customer) {
            ...
            // New customer must verify OTP before they can login.
        ...
        try {
            Mail::to($customer->email)->send(new OtpMail($otp, $customer->full_name));
            ...
            return response()->json([
                'message' => 'Registration created, but OTP email could not be sent. Please use resend OTP.',
                'email' => $customer->email,
                'verified' => false,
                'requires_otp' => true,
                'otp_sent' => false,
